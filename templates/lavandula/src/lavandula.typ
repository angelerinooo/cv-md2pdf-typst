...
#let section-element(title: "", info: "", body) = {
  block(
    ...
    grid(
      ...
      text(size: sizes.text-default, info),
      grid.cell(colspan: 2)[
...
#let lavandula-theme(custom-colors: (:), body) = context {
  ...
  colors.update((
    ...
    highlight: new-base-colors.primary.darken(20%),
    // Titles
  ...
  context {
    ...
    show highlight: it => context text(fill: get-color("highlight"), it.body, weight: "semibold")
